...
class Robot:
    ...
    def act(self, game):
        ...
        # funkcja zwróci prawdê, je¿eli w odleg³oœci 2 kroków z przodu jest wróg
        def zprzodu(l1, l2):
            if rg.wdist(l1, l2) == 2:
                if abs(l1[0] - l2[0]) == 1:
                    return False
        ...
        # funkcja zwróci wspó³rzêdne pola œrodkowego miêdzy dwoma innymi
        ...
        # je¿eli jesteœ w punkcie wejœcia, opuœæ go
        ...
        # je¿eli wróg jest o dwa kroki, atakuj
